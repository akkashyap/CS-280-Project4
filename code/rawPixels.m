...
for i = 1 : 7
    ...
    for cIndex = 1:numberOfCValue
        ...
        %model = train(trainingLabels, sparse(double(imagesAsColumns)), stringToInsert{1});  %num1
        %model2 = train(trainingLabels, sparse(double(spatialPyramid)), stringToInsert{1});  %num2
        ...
        finalCAverages(cIndex,1) = (err_rate*100) +  finalCAverages(cIndex,1) ; 
